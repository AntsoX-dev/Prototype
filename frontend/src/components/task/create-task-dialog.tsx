...
import { createTaskSchema } from "../../libs/schema";
import type { ProjectMemberRole, Utilisateur } from "../../types";
...
interface CreateTaskDialogProps {
    ...
    projectId: string;
    projectMembers: { user: Utilisateur; role: ProjectMemberRole }[];
}
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                                ...
                                                <FormControl>
                                                    ...
                                                    >
                                                        <FormItem>
                                                            <FormControl>
                                                                <SelectTrigger className="w-full">
                                                                    <SelectValue placeholder="Selectionnez la priorité" />
                                                                </SelectTrigger>
                                                            </FormControl>
                        ...
                        <DialogFooter>
                            <Button type="submit" disabled={isPending}>
                                {isPending ? "Création..." : "Créer une tâche"}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>
