...
import { getProjectProgress } from "../../libs";
                ...
                <Tabs defaultValue="all" className="w-full">
                        ...
                        <div className="flex items-center text-sm">
                            ...
                            <div>
                                <Badge variant="outline" className="bg-background">
                                    {tasks.filter((task) => task.status === "To Do").length} {statusLabels["To Do"]}
                                </Badge>
                                <Badge variant="outline" className="bg-background">
                                    {tasks.filter((task) => task.status === "In Progress").length} {statusLabels["In Progress"]}
                                </Badge>
                                <Badge variant="outline" className="bg-background">
                                    {tasks.filter((task) => task.status === "Done").length} {statusLabels["Done"]}
                                </Badge>
                    ...
                    <TabsContent value="all" className="m-0">
                        <div className="grid grid-cols-3 gap-4">
                            <TaskColumn
                                title={statusLabels["To Do"]}
                                tasks={tasks.filter((task) => task.status === "To Do")}
                                onTaskClick={handleTaskClick}
                            />

                            <TaskColumn
                                title={statusLabels["In Progress"]}
                    ...
                    <div className="flex gap-1">
                        {task.status !== "To Do" && (
                            ...
                            >
                                ...
                                <span className="sr-only">Marquer comme à faire</span>
                            </Button>
                        )}
                        {task.status !== "In Progress" && (
                            ...
                            >
                                ...
                                <span className="sr-only">Marquer comme en cours</span>
                            </Button>
                        )}
                        {task.status !== "Done" && (
                            <Button
                            ...
                            >
                                ...
                                <span className="sr-only">Marquer comme terminé</span>
                            </Button>
                        )}
                    </div>
                </div>
